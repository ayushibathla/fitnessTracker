...
import { useNavigate } from 'react-router-dom';
 ...
 return (
      <div className='pt-2 container-sm' style={{width: '500px'}}>

            <div className='text-center' style={{width: '480px'}}>
                <h2 className='display-4 fw-semibold pb-3 bg-primary rounded-5 rounded-top-0 text-white'>Register</h2>
            </div>

            <form onSubmit={handleRegisterSubmit} className='shadow form-control p-3 d-flex text-center justify-content-center align-items-center flex-column border border-1'>
                <div className=''>
                    <label className='d-flex flex-column gap-1 fw-semibold form-label'>
                        First Name:
                ...
                <button type="submit" className='btn btn-success w-75 fw-semibold'>Create</button>
            </form>
